...
public class addTeacherdatabase {
    private String Fullname,email,degree,courese,birthofdate,numbers,uid,addresss;

    public addTeacherdatabase() {
    }

    public addTeacherdatabase(String fullname, String email, String degree, String courese, String birthofdate, String numbers, String uid, String addresss) {
